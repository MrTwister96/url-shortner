<template>
	<base-layout>
		<div
			class="flex flex-col lg:flex-row w-full md:w-8/12 justify-center p-5 space-y-2 md:space-x-20"
		>
			<div class="flex flex-col items-center">
				<h1 class="text-xl md:text-3xl font-semibold w-11/12 text-left">
					Links that last...
				</h1>
				<p class="w-11/12 text-left md:text-lg">
					This is a URL Shortner built for your convinience, to generate URLs
		...
		<div
			class="bg-gray-900 bg-opacity-50 p-10 rounded-md flex flex-col shadow-md w-full md:w-8/12"
		>
			<div class="flex flex-row space-x-2 justify-between">
				<base-input class="w-full" placeholder="URL to shorten"></base-input>
...
export default {
	components: { BaseLayout, BaseButton, BaseInput },
	setup() {},
};
</script>
